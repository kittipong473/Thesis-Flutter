...
<body style="background-color:purple">
    ...
    ?>
    <div class="container">
        <div class="login_area" style="height:750px;margin:left;background-color:lightskyblue">
            <br><img src="image/mechanic.png" alt="" width="100px" height="100px">
            <h1>Confirm Information</h1><br>
            <form action="confirm_super.php" method="POST">
                <input type="hidden" name="superID" value="<?php echo $row['superID'] ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="telephone" style="width:300px;padding:10px;" maxlength="10" required><br><br>
                </div>
                <div class="form-group">
                    <label for="garageName">Garage : </label>&nbsp&nbsp&nbsp&nbsp
                    <input type="text" name="garageName" placeholder="สำหรับผู้ใช้งานที่มีอู่สังกัดในข้อมูลแล้ว" style="width:300px;padding:10px;" maxlength="20"><br><br><br>
                </div>
